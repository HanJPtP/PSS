           ...
           <el-form  :inline="true">
               <el-form-item label="注册账号:">
                ...
                <el-form-item label="初始密码:">   
                  <el-input placeholder="请输入初始密码" type="text" v-model="staff.password"></el-input>
                </el-form-item>
 ...
 name:'StaffAdd',
  data () {
    return {
        ...
        postList:'',//职位列表
        StaffAddVisible: false//控制内容是否显示，false表示隐藏
    };
  },
  methods: {
        //取消按钮
        btnexit(){
          this.staff={account:'',password:'',username:'',phone:'',pid:''};
          this.UserAddVisible=false;
        },
        //添加员工
        btnUserAdd(){
          this.$axios.post('/api/staff/add',this.staff)
          .then(result=>{
