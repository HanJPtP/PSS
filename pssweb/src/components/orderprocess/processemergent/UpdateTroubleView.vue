          ...
          <el-form :inline="true">
           ...
           <el-form-item label="工单类型">
            ...
            <el-form-item label="添加处理人">
              <el-select v-model="pssOrderProcess.handlerList" multiple placeholder="请选择">
              <el-option
            ...
            <el-form-item label="负责的区域">
             ...
             <br/>
              ...
              <el-button @click="gettools" size="mini" type="primary">选择</el-button>
            </el-form-item>
            <br/>
            <el-form-item label="遇到的问题">
              <el-button @click="getproblem" size="mini" type="primary">填写</el-button>
            </el-form-item>
            <br/>
      ...
      <span slot="footer" class="dialog-footer">
        <el-row type="flex" justify="center" align="middle">
          <el-col :span="15">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <el-button type="primary" @click="doit"
              >提 交</el-button
            >
          </el-col>
        </el-row>
...
<!-- 引入工具选择列表组件 -->
    ...
    <!-- 遇到的问题组件 -->
    <about-problem-view ref="aboutproblem" v-on:getfile1="getfiles1" @gettext1="gettexts1"></about-problem-view>
  </div>
</template>
...
import toolsListView from "@/components/orderprocess/processemergent/ToolsListView.vue";
import aboutProblemView from "@/components/orderprocess/processemergent/AboutProblemView.vue";
  ...
  methods: {   
    ...
    if(confirm('确定提交吗？')){
      ...
      for(let i=0;i < this.pssOrderProcess.handlerList.length;i++){
        this.pssOrderProcess.handlerno +=','+this.pssOrderProcess.handlerList[i];
      }
      
        this.pssOrderProcess.handlerList=new Array();
        console.log("11--11");
        console.log(this.pssOrderProcess);
         this.$axios.post("/api/processorder/add",this.pssOrderProcess)
          .then(result=>{
    ...
    handleClose(done) {
      this.$confirm("确认关闭？")
        ...
        this.$axios.post("/api/taskorder/update",this.pssOrderTask)
            .then(result=>{
