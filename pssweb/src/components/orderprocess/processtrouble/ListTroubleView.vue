    ...
    <el-row>
      <el-col :span="24">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>维护维修列表</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
    </el-row>
    <!-- 导航结束 -->
...
// 引入修改（填写）组件
import updateTroubleView from "@/components/orderprocess/processtrouble/UpdateTroubleView.vue";
//引入查看详情组件
import detailView from "@/components/orderprocess/processtrouble/DetailView.vue";
